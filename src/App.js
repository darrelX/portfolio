  ...
  return (
    <div className="modal" role="dialog" aria-modal="true">
      ...
      <div className="modal__dialog">
        <button className="modal__close" aria-label="Fermer" onClick={onClose}>×</button>
...
function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://formsubmit.co/ajax/fowengtcho@gmail.com', {
        method: 'POST',
        headers: {
  ...
  if (isSubmitted) {
    return (
      <div className="contact-success" style={{ textAlign: 'center', padding: '2rem' }}>
        <div className="success-icon">✓</div>
        <h3 style={{ color: 'var(--success)', marginBottom: '1rem' }}>Message envoyé !</h3>
  ...
  return (
    <form className="contact-form" onSubmit={handleSubmit}>
      ...
      {error && (
        <div className="glass" role="alert" style={{ padding: '1rem', borderLeft: '4px solid var(--error)', color: 'var(--text-primary)' }}>
          {error}
        </div>
      )}
      <div className="field">
...
export default function App() {
          ...
          <div className="header-content">
            ...
            <nav className="nav">
              ...
              <ul className={`nav__list${navOpen ? ' nav__list--open' : ''}`}>
                ...
                <li><a href="#experience">{L.nav.exp}</a></li>
                <li><a href="#projets">{L.nav.projects}</a></li>
              ...
              <button className="theme-toggle" aria-label="Basculer le thème" title="Thème" onClick={toggle}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 3a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0V4a1 1 0 0 1 1-1Zm0 15a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm8-5a1 1 0 0 1 1 1h1a1 1 0 1 1 0 2h-1a1 1 0 1 1-2 0 1 1 0 0 1 1-1Zm-8 7a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0v-1a1 1 0 0 1 1-1ZM3 12a1 1 0 0 1 1-1H5a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1Zm1.64-6.36a1 1 0 0 1 1.41 0l.71.7A1 1 0 0 1 6 7.1l-.7-.7a1 1 0 0 1 0-1.42ZM17.3 17.3a1 1 0 0 1 1.41 0l.71.7A1 1 0 0 1 18.7 20l-.7-.7a1 1 0 0 1 0-1.42ZM17.3 6.7a1 1 0 0 1 0-1.41l.7-.71a1 1 0 0 1 1.42 1.42L18.7 6.7A1 1 0 0 1 17.3 6.7ZM5.3 17.3A1 1 0 0 1 6.7 18.7l-.7.7A1 1 0 0 1 4.6 18l.7-.7Z" fill="currentColor"/>
                </svg>
              </button>
            </nav>
          </div>
          ...
          <div className="hero__grid">
            <div className="hero__intro reveal">
              <h1>
                ...
                {L.heroHello} <span className="gradient-text">{personalData.name}</span>
              </h1>
              <p className="lead">
                {personalData.bio}
              </p>
              <div className="cta">
                <a className="btn btn--primary" href={personalData.cta.primary.link}>{personalData.cta.primary.text}</a>
                <a className="btn btn--ghost" href={personalData.cta.secondary.link}>{personalData.cta.secondary.text}</a>
              </div>
              <div className="socials">
                <a href={personalData.social.github} target="_blank" rel="noreferrer" aria-label="GitHub" className="social">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill="currentColor" d="M12 2C6.48 2 2 6.58 2 12.26c0 4.5 2.87 8.31 6.84 9.66.5.09.68-.22.68-.49 0-.24-.01-.87-.01-1.71-2.78.62-3.37-1.37-3.37-1.37-.45-1.17-1.12-1.48-1.12-1.48-.92-.64.07-.63.07-.63 1.02.07 1.55 1.07 1.55 1.07.9 1.58 2.36 1.12 2.94.85.09-.67.35-1.12.63-1.38-2.22-.26-4.56-1.14-4.56-5.08 0-1.12.39-2.03 1.03-2.75-.1-.26-.45-1.32.1-2.75 0 0 .85-.28 2.78 1.05.81-.23 1.68-.35 2.55-.35s1.74.12 2.55.35c1.93-1.33 2.78-1.05 2.78-1.05.55 1.43.2 2.49.1 2.75.64.72 1.03 1.63 1.03 2.75 0 3.95-2.34 4.81-4.57 5.07.36.32.68.95.68 1.92 0 1.38-.01 2.49-.01 2.83 0 .27.18.59.69.49A10.04 10.04 0 0 0 22 12.26C22 6.58 17.52 2 12 2Z"/>
                  </svg>
                </a>
                <a href={personalData.social.linkedin} target="_blank" rel="noreferrer" aria-label="LinkedIn" className="social">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill="currentColor" d="M20.45 20.45h-3.55v-5.6c0-1.34-.03-3.06-1.87-3.06-1.87 0-2.16 1.46-2.16 2.96v5.7H9.32V9h3.41v1.56h.05c.47-.9 1.61-1.85 3.31-1.85 3.54 0 4.19 2.33 4.19 5.36v6.38ZM6.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12ZM4.57 20.45h3.55V9H4.57v11.45Z"/>
                  </svg>
                </a>
              </div>
            </div>
            <div className="hero__visual reveal">
              <div className="blob">
                <img src={personalData.profileImage} alt={`Portrait de ${personalData.name}`} loading="lazy" />
              </div>
      ...
      <section id="experience" className="section">
        <div className="container">
          <div className="section__head reveal">
            ...
            <p>Douala, Cameroun — Tel: (+237) 6 57 59 08 08 — fowengtcho@gmail.com</p>
          </div>
            ...
            {experience.map((exp, index) => (
              <div key={index} className="tl">
                <div className="tl__head">
                  ...
                  <span className="tl__meta">{exp.location} • {exp.period}</span>
                </div>
  ...
  <section id="education" className="section">
          ...
          <div className="about reveal">
            {educationData.map((edu, index) => (
              <div key={index} className="about__card glass">
                <h3>{edu.title}</h3>
                <p><strong>{edu.subtitle}</strong><br/>
                {edu.period}<br/>
                {edu.institution}</p>
            ...
            <div className="contact-info">
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <div className="contact-content">
                    <h4>Email</h4>
                    <a href={`mailto:${personalData.contact.email}`}>{personalData.contact.email}</a>
                  </div>
                </div>
                <div className="contact-item">
                  <div className="contact-icon">📱</div>
                  <div className="contact-content">
                    <h4>Téléphone</h4>
                    <a href={`tel:${personalData.contact.phone.replace(/\s/g, '')}`}>{personalData.contact.phone}</a>
                  </div>
                </div>
                <div className="contact-item">
                  <div className="contact-icon">📍</div>
              ...
              <div className="contact-social">
                ...
                <div className="social-links">
                  <a href={personalData.social.github} target="_blank" rel="noreferrer" className="social-link">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path fill="currentColor" d="M12 2C6.48 2 2 6.58 2 12.26c0 4.5 2.87 8.31 6.84 9.66.5.09.68-.22.68-.49 0-.24-.01-.87-.01-1.71-2.78.62-3.37-1.37-3.37-1.37-.45-1.17-1.12-1.48-1.12-1.48-.92-.64.07-.63.07-.63 1.02.07 1.55 1.07 1.55 1.07.9 1.58 2.36 1.12 2.94.85.09-.67.35-1.12.63-1.38-2.22-.26-4.56-1.14-4.56-5.08 0-1.12.39-2.03 1.03-2.75-.1-.26-.45-1.32.1-2.75 0 0 .85-.28 2.78 1.05.81-.23 1.68-.35 2.55-.35s1.74.12 2.55.35c1.93-1.33 2.78-1.05 2.78-1.05.55 1.43.2 2.49.1 2.75.64.72 1.03 1.63 1.03 2.75 0 3.95-2.34 4.81-4.57 5.07.36.32.68.95.68 1.92 0 1.38-.01 2.49-.01 2.83 0 .27.18.59.69.49A10.04 10.04 0 0 0 22 12.26C22 6.58 17.52 2 12 2Z"/>
                    </svg>
                    <span>GitHub</span>
                  </a>
                  <a href={personalData.social.linkedin} target="_blank" rel="noreferrer" className="social-link">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path fill="currentColor" d="M20.45 20.45h-3.55v-5.6c0-1.34-.03-3.06-1.87-3.06-1.87 0-2.16 1.46-2.16 2.96v5.7H9.32V9h3.41v1.56h.05c.47-.9 1.61-1.85 3.31-1.85 3.54 0 4.19 2.33 4.19 5.36v6.38ZM6.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12ZM4.57 20.45h3.55V9H4.57v11.45Z"/>
                    </svg>
                    <span>LinkedIn</span>
      ...
      <footer className="site-footer">
        <div className="container">
          <p>© <span>{currentYear}</span> {personalData.name} — Tous droits réservés.</p>
        </div>
      </footer>
